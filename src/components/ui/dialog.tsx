  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          // 🔥 Estilos atualizados para largura ampla
          "bg-background fixed top-1/2 left-1/2 z-50 grid w-full max-w-[90vw] h-[85vh] translate-x-[-50%] translate-y-[-50%]  rounded-lg border p-0 shadow-lg duration-200",

          // ⚠️ Removido o `sm:max-w-lg` que limitava a largura
          className
        )}
        {...props}
      >
